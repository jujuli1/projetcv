...
const Presentation = () => {
     ...
     {/* déploiement gauche --> droite page presentation */ }
...
<path id='sign' d="M358 393C368.057 393 370.405 385.595 377 379" stroke="black" stroke-width="3" stroke-linecap="round"/>
            ...
            <div className='paragraphequi'>
                <p >Actuellement en reconversion professionnel dans les métiers du numérique, et ayant obtenue le titre professionnel développeur web et web mobile avec l'école O'clock, je suis actuellement à la recherche d'une premiere experience professionnel, d'une formation en alternance ou d'un stage dans ce domaine</p>
            <p >Je suis motivé par la volonté d'effectué un metier dans un domaine que j'affectionne et que je pratique depuis longtemps en tant qu'amateur, l'informatique et les métiers du numérique en général</p>
